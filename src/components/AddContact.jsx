...
const AddContact = ({showPopUp, relations, sexs}) => {
    ...
    const submitHandler = async (e) => {
        ...
        if(Object.keys(errors).length === 0) {
            try {
                ...
                setLoading(true);
                const {status} = await createContact(contactValues);
                if(status === 201){
                    // Change showPopUp function in App.js for render the showPopUp component
                    showPopUp(true, "Contact Create Successful");
            ...
            <div className='form'>
                <form onSubmit={submitHandler}>
                    ...
                    <div className='create-back-btn'>
                        <input value='Create' type='submit' className='create-btn' />
